...
public:
  ...
  */
  enum PainterMode { pmDefault       = 0x00   ///< <tt>0x00</tt> Default mode for painting on screen devices
                     ,pmVectorized   = 0x01   ///< <tt>0x01</tt> Mode for Qvectorized painting (e.g. PDF export). For example, this prevents some antialiasing fixes.
                     ...
                     ,pmNonCosmetic  = 0x04   ///< <tt>0x04</tt> Turns pen widths 0 to 1, i.e. disables cosmetic pens. (A cosmetic pen is always drawn with width 1 pixel in the Qvector image/pdf viewer, independent of zoom.)
                   };
